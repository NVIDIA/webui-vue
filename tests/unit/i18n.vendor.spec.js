...
describe('i18n vendor overlays', () => {
  ...
  test('falls back to vendor root overlays when env has hyphenated suffix', async () => {
    ...
    const translated = i18nInstance.global.t('pageDumps.dumpTypes.systemHgxDump');
