 ...
 * @version 1.24.0
 */
export type ManagerSerialConnectTypesSupported =
    (typeof ManagerSerialConnectTypesSupported)[keyof typeof ManagerSerialConnectTypesSupported];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ManagerSerialConnectTypesSupported = {
