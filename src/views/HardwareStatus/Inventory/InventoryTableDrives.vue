...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        {
          key: 'Model',
          label: i18n.global.t('pageInventory.table.model'),
          formatter: this.dataFormatter,
          sortable: true,
        },
        {
          key: 'MediaType',
          label: i18n.global.t('pageInventory.table.mediaType'),
          formatter: this.dataFormatter,
          sortable: true,
        },
        {
  ...
  methods: {
    ...
    formatCapacity(bytes) {
      ...
      const units = [
        i18n.global.t('unit.byte'),
        i18n.global.t('unit.kilobyte'),
        i18n.global.t('unit.megabyte'),
        i18n.global.t('unit.gigabyte'),
        i18n.global.t('unit.terabyte'),
        i18n.global.t('unit.petabyte')
      ];
    ...
    formatValueWithUnit(value, unitKey) {
      ...
      return `${this.dataFormatter(value)} ${i18n.global.t(unitKey)}`;
    }
  },
};
</script> 