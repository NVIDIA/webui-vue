  ...
  methods: {
    executeReset() {
      ...
      if (resetInfo) {
        ...
        if (resetInfo.category === 'shutdown') {
          modalMessage = i18n.global.t('pageServerPowerOperations.modal.confirmShutdownMessage');
          modalTitle = i18n.global.t('pageServerPowerOperations.modal.confirmShutdownTitle');
        } else if (resetInfo.category === 'virtualMachine' && ['Pause', 'Suspend'].includes(this.selectedResetType)) {
          modalMessage = i18n.global.t('pageServerPowerOperations.modal.confirmPauseMessage', 
            { operation: this.getResetTypeLabel(this.selectedResetType) });
          modalTitle = i18n.global.t('pageServerPowerOperations.modal.confirmPauseTitle');
        } else if (resetInfo.category === 'virtualMachine' && this.selectedResetType === 'Resume') {
          modalMessage = i18n.global.t('pageServerPowerOperations.modal.confirmResumeMessage');
          modalTitle = i18n.global.t('pageServerPowerOperations.modal.confirmResumeTitle');
        } else if (resetInfo.category === 'special') {
          modalMessage = i18n.global.t('pageServerPowerOperations.modal.confirmSpecialOperationMessage', 
            { operation: this.getResetTypeLabel(this.selectedResetType) });
          modalTitle = i18n.global.t('pageServerPowerOperations.modal.confirmSpecialOperationTitle');
        } else if (resetInfo.category === 'powerOn') {
          modalMessage = i18n.global.t('pageServerPowerOperations.modal.confirmPowerOnMessage', 
            { operation: this.getResetTypeLabel(this.selectedResetType) });
          modalTitle = i18n.global.t('pageServerPowerOperations.modal.confirmPowerOnTitle');
        } else {
          // Default for restart and power cycle
          modalMessage = i18n.global.t('pageServerPowerOperations.modal.confirmRebootMessage');
          modalTitle = i18n.global.t('pageServerPowerOperations.modal.confirmRebootTitle');
        }
      } else {
        ...
        if (typeLower.includes('off') || typeLower.includes('shutdown') || typeLower.includes('halt')) {
          ...
          modalMessage = i18n.global.t('pageServerPowerOperations.modal.confirmGenericOperationMessage', 
            { operation: this.getResetTypeLabel(this.selectedResetType) });
          modalTitle = i18n.global.t('pageServerPowerOperations.modal.confirmGenericOperationTitle');
        }
      }
    ...
    getResetTypeLabel(resetType) {
      ...
      if (info && info.labelKey) {
        ...
        return i18n.global.t(info.labelKey);
      } else {
    ...
    getResetTypeDescription(resetType) {
      ...
      if (info) {
        ...
        if (info.descriptionKey && i18n.global.te(info.descriptionKey)) {
          return i18n.global.t(info.descriptionKey);
        } 
