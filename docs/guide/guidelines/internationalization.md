...
- Place shared vendor strings in the vendor root folder, ex: `src/env/locales/nvidia/`
- Place project-specific overrides in the variant folder when needed, ex: `src/env/locales/nvidia-gb/`
