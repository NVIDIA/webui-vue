...
| VITE_EVENT_LOGS_TOGGLE_BUTTON_DISABLED  | If true, disables (hides) toggle button in Event Logs UI (feature flag)            |
...
| VITE_FAN_DATA_FROM_THERMAL_SUBSYSTEM    | If true, reads fan data from Thermal subsystem (feature flag)                      |
